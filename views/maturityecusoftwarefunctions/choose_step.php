                    ...
                    <div class="panel" id="shortcut">
                        ...
                        <div class="panel-body mt10">
                            ...
                            <div class="section row text-center">
                                ...
                                <div class="col-md-4  mb5">
                                    <a href="<?= BASE_URL; ?>maturityecusoftwarefunctions/unitConceptTestsProvider?maturityecusoftwarefunctions_id=<?= $_GET['maturityecusoftwarefunctions_id']; ?>" class="btn fs14 btn-primary " title="Insira as informações solicitadas.">Testes unitários ou conceito.</a>
                                </div>
