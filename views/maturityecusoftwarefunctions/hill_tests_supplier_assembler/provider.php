...
<header id="topbar" class="breadcrumb_style_2">
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-current-item">Testes em Hill no fornecedor ou montadora</li>
        </ol>
    </div>
</header>
...
<!-- Content -->
<?php if (!isset($info_maturityecusoftwarefunctions_hill_tests_supplier_assembler) || count($info_maturityecusoftwarefunctions_hill_tests_supplier_assembler) <= 0) : ?>
                    ...
                    <div class="allcp-form tab-pane mw1000 mauto" id="order" role="tabpanel">
                        <div class="panel" id="shortcut">
                            ...
                            <div class="panel-heading text-center">
                                <span class="panel-title pn">Testes em Hill no fornecedor ou montadora - Fornecedor</span><br>
                                <span class="fa fa-circle"></span>
                            </div>

                            <form method="post" action="<?= BASE_URL; ?>maturityecusoftwarefunctions/hill_tests_supplier_assembler" id="form-order" enctype="multipart/form-data">
                                <div class="panel-body pn">
                                    ...
                                    <div class="section row">
                                        ...
                                        <div class="col-md-12 ph10 mb5">
                                            <label for="assembler_email" class="field prepend-icon">
                                                <input type="text" name="assembler_email" id="assembler_email" class="gui-input" placeholder="Separe com ; (ponto e vírgula) os e-mails." required value="<?= (isset($info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['assembler_email'])) ? $info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['assembler_email'] : ""; ?>">
                                    ...
                                    <div class="section row">
                                        <div class="col-md-12 ph10 mb5">
                                            ...
                                            <?= (isset($info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['reason_email'])) ? $info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['reason_email'] : ""; ?>
                                            </textarea>
                                                <span class="field-icon">
                                        ...
                                        <div class="col-md-12 ph10 mb5">
                                            ...
                                            <div class="panel mb50" id="p5">
                                                ...
                                                <label class="field prepend-icon file mb20 mt10">
                                                    ...
                                                    <input type="text" id="result_file" name="result_file" class="gui-input fluid-width" placeholder="selecione um arquivo" value="<?= (isset($info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['result_file'])) ? $info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['result_file'] : ""; ?>">
                                    ...
                                    <div class="section text-center">
                                        ...
                                        <?php if (isset($info_maturityecusoftwarefunctions_hill_tests_supplier_assembler) && $info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['link'] != "" && $info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['assembler_email'] == "") :
                                        ?>
                                            <button type="submit" class="btn btn-primary">Enviar</button>

                                        <?php elseif ($info_maturityecusoftwarefunctions['step_3'] == 1) : ?>
                                            <a href="<?= BASE_URL; ?>maturityecusoftwarefunctions/hillTestsSupplierAssemblerDownload?maturityecusoftwarefunctions_id=<?= $_GET['maturityecusoftwarefunctions_id']; ?>" class="btn btn-primary" title="Clique para abrir o PDF">ETAPA CONCLUÍDA</a> <br> <br>
                                            <?php if (isset($info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['result_file'])) : ?>
                                                <a href="<?= BASE_URL; ?><?= $info_maturityecusoftwarefunctions_hill_tests_supplier_assembler['result_file']; ?>" download class="btn btn-info">Resultado </a>
                                            <?php endif; ?>
