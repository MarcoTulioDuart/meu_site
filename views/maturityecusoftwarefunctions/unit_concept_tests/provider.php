                                ...
                                <div class="panel-body pn">
                                    ...
                                    <div class="section text-center">
                                        ...
                                        <?php elseif (count($info_maturityecusoftwarefunctions_unit_concept_tests_provider) > 0) : ?>
                                            ...
                                            <a href="<?= BASE_URL; ?>maturityecusoftwarefunctions/complete_stage?step=step_2&percentual_step=10&maturityecusoftwarefunctions_id=<?= $_GET['maturityecusoftwarefunctions_id']; ?>" class="btn btn-info">Aprovar</a>
                                            <div id="animation-switcher" style="margin-top:10px;">
