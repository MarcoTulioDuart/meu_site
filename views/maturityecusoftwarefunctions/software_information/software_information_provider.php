                            ...
                            <div class="panel-body pn">
                                ...
                                <div class="section text-center">
                                    ...
                                    <?php elseif (count($maturityecusoftwarefunctions_software_informations_providers) > 0) : ?>
                                        ...
                                        <a href="<?= BASE_URL; ?>maturityecusoftwarefunctions/completeStage?step=step_1&percentual_step=10&maturityecusoftwarefunctions_id=<?= $_GET['maturityecusoftwarefunctions_id']; ?>" class="btn btn-info">Aprovar</a>
