                            ...
                            <div class="panel-body pn">
                                ...
                                <div class="section row">
                                    <div class="col-md-12 ph10 mb5">
                                        ...
                                        <label for="description_function_software" class="field prepend-icon">
                                            ...
                                            <textarea name="description_function_software" id="description_function_software" cols="30" rows="10" class="gui-textarea" placeholder="Descreva em até duas linhas:" required></textarea>
                                ...
                                <div class="section row">
                                    <div class="col-md-12 ph10 mb5">
                                        ...
                                        <label for="motivation_applying_function_software" class="field prepend-icon">
                                            ...
                                            <textarea name="motivation_applying_function_software" id="motivation_applying_function_software" cols="30" rows="10" class="gui-textarea" placeholder="Descreva em até duas linhas:" required></textarea>
                                            <span class="field-icon">
                                                <i class="fa fa-list"></i>
                                            </span>
                                        </label>
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><input type="date" name="releases_date[]" value="<?= date("Y-m-d"); ?>" required></td>
                                                        <td><input type="date" name="releases_date[]" value="<?= date("Y-m-d"); ?>" required></td>
                                                        <td><input type="date" name="releases_date[]" value="<?= date("Y-m-d"); ?>" required></td>
                                                        <td><input type="date" name="releases_date[]" value="<?= date("Y-m-d"); ?>" required></td>
                                                    ...
                                                    <tr>
                                                        <td><input type="text" name="releases_desc[]" required></td>
                                                        <td><input type="text" name="releases_desc[]" required></td>
                                                        <td><input type="text" name="releases_desc[]" required></td>
                                                        <td><input type="text" name="releases_desc[]" required></td>
                                                    </tr>
                                ...
                                <div class="section text-center">
                                    ...
                                    <?php elseif (count($maturityecusoftwarefunctions_software_informations_providers) > 0) : ?>
                                        ...
                                        <a href="<?= BASE_URL; ?>maturityecusoftwarefunctions/complete_stage?step=step_1&percentage=20&maturityecusoftwarefunctions_id=<?= $_GET['maturityecusoftwarefunctions_id']; ?>" class="btn btn-primary">Aprovar</a>
