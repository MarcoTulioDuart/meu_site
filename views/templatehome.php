            ...
            <div class="sidebar-left-content nano-content">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li class="<?= ($viewData['page'] == 'function_integration') ? 'active' : ''; ?>">
                        ...
                        <ul class="nav sub-nav">
                            <li>
                                <a href="<?= BASE_URL; ?>functionintegration">Integração entre Funções, Cliente e
                                    Serviço</a>
                            </li>
                            <li>
                    ...
                    <li class="<?= ($viewData['page'] == 'maturityecusoftwarefunctions') ? 'active' : ''; ?>">
                        <a class="accordion-toggle">
                            <span class="caret"></span>
                        ...
                        <ul class="nav sub-nav">
                            <li>
                                <a href="<?= BASE_URL; ?>maturityecusoftwarefunctions">Maturidade de ECU's, Softwares e Funções</a>
                            </li>
                            <li>
                                <a href="<?= BASE_URL; ?>maturityecusoftwarefunctions/chooseProjectResults">Resultados de Testes</a>
                            </li>
                    ...
                    <li class="<?= ($viewData['page'] == 'system') ? 'active' : ''; ?>">
                        ...
                        <ul class="nav sub-nav">
                            ...
                            <li>
                                <a href="<?= BASE_URL; ?>system/add_parameters">Adicionar base de dados de
                                    Parâmetros</a>
                            </li>
                            <li>
                                <a href="<?= BASE_URL; ?>system/add_vehicle_portfolio">Adicionar portfolio de
                                    Veículos</a>
                            </li>
                            <li>
