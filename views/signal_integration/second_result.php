        ...
        <div class="panel-body">
            ...
            <form action="<?= BASE_URL; ?>signalintegration/send_report" method="post" enctype="multipart/form-data">
                ...
                <div class="section">
                    ...
                    <div class="section row">
                        <h6 class="text-center text-muted">Selecione o CAN trace</h6>
                        <label class="field prepend-icon file mb20 mt10">

                            <input type="file" name="can_trace" class="gui-file" onchange="document.getElementById('uploader3').value = this.value;">
