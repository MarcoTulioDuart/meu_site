<header id="topbar" class="breadcrumb_style_2">
    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-current-item">Lista de CAN</li>
        </ol>
    </div>
</header>
<!-- /Topbar -->
                ...
                <div class="allcp-form tab-pane mw700 mauto" id="order" role="tabpanel">
                    <div class="panel" id="shortcut">
                        <div class="panel-heading text-center pb25">
                            <span class="panel-title pn">Lista de CANs</span>
                        </div>
    ...
    <div class="panel">
        <div class="panel-heading text-center">
            <span class="panel-title">
                Adicionar Tipo de Rede CAN
            </span>
        </div>
        <!-- /Panel Heading -->
        <form method="post" action="<?= BASE_URL; ?>admin/add_can" id="form-order" enctype="multipart/form-data">
            <div class="panel-body">
                <div class="section row">
                    <div class="col-md-12 ph10 mb5">
                        <label for="name" class="field prepend-icon">
                            <input type="text" name="name" id="name" class="gui-input" placeholder="Digite o nome da can">
