<header id="topbar" class="breadcrumb_style_2">
    <?php if (isset($_COOKIE["success_add_ecu"])) : ?>
        <div class="text-center">
            <div class="alert alert-alert alert-dismissable mb30 alert-block p15">
                ...
                <p><?= $_COOKIE["success_add_ecu"]; ?></p>
            </div>
        </div>
    <?php endif; ?>
    <?php if (isset($_COOKIE["failed_add_ecu"])) : ?>
        <div class="text-center">
            <div class="alert alert-warning alert-dismissable mb30 alert-block p15">
                <button type="button" class="close mt15" data-dismiss="alert" aria-hidden="true">×</button>
                <h3 class="mtn fs20 text-white">Sucesso</h3>
                <p><?= $_COOKIE["failed_add_ecu"]; ?></p>
            </div>
        </div>
    <?php endif; ?>
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-current-item">Adicionar ECU</li>
        </ol>
    </div>
</header>
<!-- /Topbar -->
                ...
                <div class="allcp-form tab-pane mw700 mauto" id="order" role="tabpanel">
                    <div class="panel" id="shortcut">
                        <div class="panel-heading text-center">
                            <span class="panel-title pn">Adicionar Tipo de ECU</span>
                        </div>
                                                ...
                                                <div class="panel-body pn">
                                                    <div class="table-responsive">
                                                        <table class="table footable" data-filter="#fooFilter">
                                                            ...
                                                            <tbody>
                                                                <?php if ($list_type_ecu == 0) : ?>
                                                                    <tr>
                                                                        <td colspan="4" class="text-center">Ainda não foi cadastrado nenhum tipo de CAN.</td>
                                                                    </tr>
                                                                <?php else : ?>
                                                                    <?php foreach ($list_type_ecu as $value) : ?>
                                                                        <tr>
                                                                            <td><?= $value['id']; ?></td>
                                                                            <td><?= $value['name']; ?></td>
                                                                            <td>
                                                                                <div class="section text-right">
                                                                                    <a href="<?= BASE_URL; ?>admin/delete_ecu/<?= $value['id']; ?>" class="btn btn-primary">
                ...
                <div class="section row">
                    <div class="col-md-12 ph10 mb5">
                        <label for="name" class="field prepend-icon">
                            <input type="text" name="name" id="name" class="gui-input" placeholder="Digite o nome do ECU">
