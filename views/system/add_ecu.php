<header id="topbar" class="breadcrumb_style_2">
    <?php if (isset($_COOKIE["success_library_ecu"])) : ?>
        <div class="text-center">
            <div class="alert alert-alert alert-dismissable mb30 alert-block p15">
                ...
                <p><?= $_COOKIE["success_library_ecu"]; ?></p>
            </div>
        </div>
    <?php endif; ?>
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-current-item">Adicionar Biblioteca ECU</li>
        </ol>
    </div>
</header>
<!-- /Topbar -->
                ...
                <div class="allcp-form tab-pane mw700 mauto" id="order" role="tabpanel">
                    <div class="panel" id="shortcut">
                        <div class="panel-heading text-center">
                            <span class="panel-title pn">Adicionar biblioteca ecu</span>
                        </div>
                        <form method="post" action="<?= BASE_URL; ?>system/add_library_ecu" id="form-order" enctype="multipart/form-data">
