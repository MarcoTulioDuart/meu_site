<header id="topbar" class="breadcrumb_style_2">
    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-current-item">Adicionar base de dados de Parâmetros</li>
        </ol>
    </div>
</header>
<!-- /Topbar -->
                ...
                <div class="allcp-form tab-pane mw700 mauto" id="order" role="tabpanel">
                    <div class="panel" id="shortcut">
                        <div class="panel-heading text-center">
                            <span class="panel-title pn">Adicionar dados de Parâmetros</span>
                        </div>
                        <form method="post" action="<?= BASE_URL; ?>system/add_parameters" id="add_parameter" enctype="multipart/form-data">
                            <div class="panel-body pn">
                                <div class="section row">
                                    <div class="col-md-12 ph10 mb5">
                                        <label for="type" class="field select">
                                            <select name="type" id="type">
                                                <option disabled selected>Tipo de Parâmetros</option>
                                                <?php foreach ($type_parameters as $value) : ?>
